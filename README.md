...
## HackerRank
- Simple Array Sum ([C++14](https://github.com/likejazz/leetcode/blob/master/hackerrank/simple-array-sum.cpp))
- Left Rotation ([C++14](https://github.com/likejazz/leetcode/blob/master/hackerrank/left-rotation.cpp))